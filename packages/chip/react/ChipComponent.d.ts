...
import "../src/index.js";
import type * as ChipComponentTypes from "../src/index";
...
export interface ChipComponentProps {
  ...
  /** undefined */
  rightslotname?: string | undefined;

  /** undefined */
  leftslotname?: string | undefined;

  /** undefined */
  chippartattribute?: string | undefined;
 ...
 *
 */
export declare function ChipComponent({
  children,
  text,
  rightslotname,
  leftslotname,
