...
import "../src/index.js";
import type * as ProgressBarComponentTypes from "../src/index";
...
export interface ProgressBarComponentProps {
  ...
  /** undefined */
  progressbarpartattribute?: string | undefined;
 ...
 *
 */
export declare function ProgressBarComponent({
  children,
  percent,
  max,
  ...
  slot,
  onClick,
}: ProgressBarComponentProps): JSX.Element;
