...
| dataStart | number | From which image number, the custom elemnet should start coming up on screen while scrolling |
| dataEnd   | number | From which image number, the custom elemnet should go off the screen while scrolling         |


<Meta title="Accelerators/Scroll" />;
