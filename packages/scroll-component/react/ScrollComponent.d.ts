...
import "../src/index.js";
import type * as ScrollComponentTypes from "../src/index";

export interface ScrollComponentProps {
  /** undefined */
  dataslot?: ScrollComponentTypes.Array<dataSlots>;
 ...
 *
 */
export declare function ScrollComponent({
  children,
  dataslot,
  desktopimages,
  mobileimages,
  ...
  slot,
  onClick,
}: ScrollComponentProps): JSX.Element;
